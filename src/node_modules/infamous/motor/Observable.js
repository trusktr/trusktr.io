...
var ObservableMixin = function ObservableMixin(base) {
    var Observable = function (_base) {
        ...
        function Observable() {
            ...
            return (0, _possibleConstructorReturn3.default)(this, (Observable.__proto__ || (0, _getPrototypeOf2.default)(Observable)).call(this, options));
        }

        (0, _createClass3.default)(Observable, [{
            key: 'on',
            value: function on(eventName, callback) {
                if (!this._eventMap) this._eventMap = new _map2.default();
    ...
    (0, _defineProperty2.default)(Observable, _hasInstance2.default, {
        value: function value(obj) {
            if (this !== Observable) return (0, _getPrototypeOf2.default)(Observable)[_hasInstance2.default].call(this, obj);
