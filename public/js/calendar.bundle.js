...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
	    ...
	    var picker = (0, _jquery2.default)('#datePicker').datepicker(datepickerOptions);
	    (0, _jquery2.default)('.bank-holiday').tooltipster(tooltipOptions);
	
	    picker.on('changeDate', function (event) {
	        currentlySelectedDate = picker.datepicker('getDate');
	        (0, _jquery2.default)('#datePickerModal #saveButton').removeClass('disabled');
	        (0, _jquery2.default)('.bank-holiday').tooltipster(tooltipOptions);
	    });
	    ...
	    (0, _jquery2.default)('#datePickerModal #saveButton').on('click', function () {
	        if (currentlySelectedDate) {
	            // save the currently selected date if there is one.
	            console.log('saving the date.');
	            savedDate = currentlySelectedDate;
	            var formattedDate = picker.datepicker('getFormattedDate');
	            (0, _jquery2.default)('#dateField').val(formattedDate).change();
	            (0, _jquery2.default)('#datePickerModal #saveButton').addClass('disabled');
	        }
	    });
	
	    (0, _jquery2.default)('#datePickerModal button.closeDatepicker').on('click', function () {
	
	        // return the calendar back to it's state if the user didn't save.
	        if (!savedDate) {
	            // the state when no date has yet been picked.
	            console.log('removing the picker');
	            picker.datepicker('remove');
	            picker = (0, _jquery2.default)('#datePicker').datepicker(datepickerOptions);
	            (0, _jquery2.default)('#datePickerModal #saveButton').addClass('disabled');
	            (0, _jquery2.default)('.bank-holiday').tooltipster(tooltipOptions);
	        } else {
	            // the state when a previous date was already saved.
	    ...
	    (0, _jquery2.default)('.datepicker .prev, .datepicker .next').on('click', function () {
	        setTimeout(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	else jQuery = __webpack_require__(1);
