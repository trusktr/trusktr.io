...
console.log(
	'web components during module load?',
...
class App extends React.Component {
	...
	render() {
		return (
			<i-scene ref="scene">
				{/* BUG: if we remove this wrapper, then content
				always renders on top of the menu for some reason.
				TODO: See if this has to do with the root context,
				and preserve-3d?
				*/}
				<i-node
					id="layoutRootNode"
				...
				>
					...
					>
						...
						<i-node id="menuHint" ref="menuHint" size="10, 20, 0" align="1, 0.5, 0" mountPoint="0, 0.5, 0">
							<div
								className="triangle"
								style={{
									position: 'absolute',
						...
						<menu id="menu">
							<li className="menuitem" style={{color: '#ccc'}}>
								Joe Pea
							</li>
							<br />
							{/*
							...
							*/}
							<li className="sub menuitem">
								<a data-route="polydance" href="">
									Polydance
								</a>
							</li>
							<br />
							<li className="sub menuitem">
								<a data-route="shadowButtons" href="">
									HTML Buttons with Lighting
								</a>
							</li>
							<br />
							<li className="sub menuitem">
								<a data-route="morphingSpiral" href="">
									Morphing ColorShape Spiral
								</a>
							</li>
							<br />
							<li className="sub menuitem">
								<a data-route="cubeWithLights" href="">
									Cube with Lights
								</a>
							</li>
							<br />
							<li className="sub menuitem frame">
								<a data-route="randomBits" href="">
									Random Bits
								</a>
							</li>
							<br />
							...
							*/}
							<li className="sub menuitem">
								<a data-route="rainbowTriangles" href="">
									Rainbow Triangles
								</a>
							</li>
							<br />
							<li className="sub menuitem">
								<a data-route="3dDomCar" href="">
									DOM Car
								</a>
							</li>
							<br />
							...
							*/}
							...
							<br />
							<li className="sub menuitem">
								<a data-route="flipDiagonal" href="">
									Diagonal Grid Flip
								</a>
							</li>
							<br />
