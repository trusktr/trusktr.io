...
async function testElementRemoval() {
    ...
    async function case2() {
        ...
        console.log('true:', node._scene instanceof Scene)

        // WebComponent#deinit is called in a following tick, so await
        await sleep(500)

        console.log('true:', node._scene === null)
    }
    ...
    // Results in: Uncaught TypeError: Cannot read property 'add' of null
    async function case4() {
        ...
        scene2.appendChild(node)
        // WebComponent#init is called sync in the same tick, so,
        console.log('true:', node._scene === null) // because scene isn't mounted.
    }
