...
function mountApp(App, container) {
	...
	if (App.__proto__ === React.Component) ReactDOM.render(<App />, container)
	else if (App.__proto__ === Preact.Component) Preact.render(Preact.createElement(App), container)
	else if (App._Ctor && App._Ctor[0].super === Vue) mountVueComponent(App, container)
}

function unmountApp(App, container) {
	if (App.__proto__ === React.Component) ReactDOM.unmountComponentAtNode(container)
	else if (App.__proto__ === Preact.Component) Preact.unmountComponentAtNode(container)
	else if (App._Ctor && App._Ctor[0].super === Vue) unmountVueComponent()
}
