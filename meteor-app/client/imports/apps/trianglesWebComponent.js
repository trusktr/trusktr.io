...
// TODO Make test out of this. Current doesn't render anything, imperativeCounterparts are never created.
export default
async function triangles() {
    ...
    appRoot.appendChild(document.createElement('color-triangles'))
    //document.createElement('motor-scene')
}
