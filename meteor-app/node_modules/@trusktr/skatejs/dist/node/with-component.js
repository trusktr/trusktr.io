...
const withComponent = exports.withComponent = (Base = HTMLElement) => (0, _withLifecycle.withLifecycle)((0, _withChildren.withChildren)((0, _withContext.withContext)((0, _withUpdate.withUpdate)((0, _withRenderer.withRenderer)(Base || HTMLElement)))));