...
function regexr(literals) {
  ...
  var result = '';
  var flags = ''; // We get the raw string that the user typed so that they don't have to
  // escape backslashes, etc, inside of the regex. Awesome!!

  literals = [].slice.call(literals.raw, 0);
  var last = literals.length - 1; //trim space before and after the regex.
  ...
  for (var i = 0; i < substitutions.length; i++) {
    result += literals[i];
    result += substitutions[i] instanceof RegExp ? substitutions[i].source : substitutions[i] ? substitutions[i].toString() : '';
