...
class PushMenuLayout extends _Molecule2.default {
    ...
    _createComponents() {
        ...
        this.mainMol = new _Molecule2.default();

        this.menuMol = new _Molecule2.default({
        ...
        this.menuContentMol = new _Molecule2.default();

        this.contentMol = new _Molecule2.default({
    ...
    setMenu(node) {
        ...
        if (node instanceof _Molecule2.default) {
