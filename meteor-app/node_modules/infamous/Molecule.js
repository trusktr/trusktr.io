...
var _RenderNode2 = require('famous/src/core/RenderNode');
...
var Molecule = exports.Molecule = function (_RenderNode) {
    (0, _inherits3.default)(Molecule, _RenderNode);
    ...
    function Molecule(initialOptions) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (Molecule.__proto__ || (0, _getPrototypeOf2.default)(Molecule)).call(this));
