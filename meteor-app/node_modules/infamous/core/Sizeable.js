    ...
    var Sizeable = function (superclass) {
        ...
        Sizeable.prototype._setPropertyObservers = function _setPropertyObservers() {
            ...
            this._properties.sizeMode.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'sizeMode');
            });
            this._properties.absoluteSize.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'absoluteSize');
            });
            this._properties.proportionalSize.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'proportionalSize');
            });
        };
        ...
        Sizeable.prototype._setPropertyXYZ = function _setPropertyXYZ(Class, name, newValue) {
            ...
            if (newValue instanceof Function) {
                ...
                this._propertyFunctions.set(name, _Motor2.default.addRenderTask(function (time) {
                    const result = newValue(this$1._properties[name]._x, this$1._properties[name]._y, this$1._properties[name]._z, time);
        ...
        Sizeable.prototype._setPropertySingle = function _setPropertySingle(Class, name, newValue, type) {
            ...
            if (newValue instanceof Function) {
                ...
                _Motor2.default.addRenderTask(function (time) {
                    const result = newValue(this$1._properties[name], time);
