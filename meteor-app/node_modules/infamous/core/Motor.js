...
Motor.prototype._startAnimationLoop = function _startAnimationLoop() {
    ...
    if (!documentIsReady) {
        return (0, _documentReady2.default)().then(function () {
...
Motor.prototype.addRenderTask = function addRenderTask(fn) {
    ...
    if (this._allRenderTasks.includes(fn)) {
        return;
    }
...
Motor.prototype._setNodeToBeRendered = function _setNodeToBeRendered(node) {
    if (this._nodesToBeRendered.includes(node)) {
        return;
    }
...
Motor.prototype._renderNodes = function _renderNodes(timestamp) {
    ...
    for (let i = 0, l = this._nodesToBeRendered.length; i < l; i += 1) {
        ...
        !(0, _Utility.isInstanceof)(node._getAncestorToBeRendered(), _Transformable2.default) &&
    ...
    for (let i = 0, l = modifiedScenes.length; i < l; i += 1) {
        ...
        if (sceneElement.webglEnabled && (webGLRenderer || (webGLRenderer = (0, _WebGLRenderer2.default)())) // only ever call getWebGlRenderer once
        ) {
