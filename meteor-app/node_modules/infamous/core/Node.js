...
class Node extends _ImperativeBase2.default.mixin(_Transformable2.default) {
    ...
    _waitForMountThenResolveMountPromise() {
        ...
        // try
        return this._getScenePromise().then(() => this._scene.mountPromise).then(logic)
