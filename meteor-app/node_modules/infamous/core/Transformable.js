    ...
    var Transformable = function (_Sizeable$mixin) {
        ...
        (0, _createClass3.default)(Transformable, [{
            ...
            value: function construct(options) {
                ...
                (0, _get3.default)(Transformable.prototype.__proto__ || (0, _getPrototypeOf2.default)(Transformable.prototype), 'construct', this).call(this, options);
            ...
            value: function _setPropertyObservers() {
                ...
                this._properties.position.on('valuechanged', function () {
                    return this$1.trigger('propertychange', 'position');
                });
                this._properties.rotation.on('valuechanged', function () {
                    return this$1.trigger('propertychange', 'rotation');
                });
                this._properties.scale.on('valuechanged', function () {
                    return this$1.trigger('propertychange', 'scale');
                });
                this._properties.origin.on('valuechanged', function () {
                    return this$1.trigger('propertychange', 'origin');
                });
                this._properties.align.on('valuechanged', function () {
                    return this$1.trigger('propertychange', 'align');
                });
                this._properties.mountPoint.on('valuechanged', function () {
                    return this$1.trigger('propertychange', 'mountPoint');
                });
            }
            ...
            value: function _render() {
                if ((0, _get3.default)(Transformable.prototype.__proto__ || (0, _getPrototypeOf2.default)(Transformable.prototype), '_render', this)) {
                    (0, _get3.default)(Transformable.prototype.__proto__ || (0, _getPrototypeOf2.default)(Transformable.prototype), '_render', this).call(this);
                }
    ...
    (0, _defineProperty2.default)(Transformable, _hasInstance2.default, {
        value: function (obj) {
            if (this !== Transformable) {
                return (0, _getPrototypeOf2.default)(Transformable)[_hasInstance2.default].call(this, obj);
            }
...
function isRealNumber(num) {
    if (typeof num != 'number' || (0, _is2.default)(num, NaN) || (0, _is2.default)(num, Infinity)) {
        return false;
    }
    return true;
}
