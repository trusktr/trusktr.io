...
const TransformableMixin = base => {
    ...
    const ParentClass = _Sizeable2.default.mixin(base);
    class Transformable extends ParentClass {
        ...
        _setPropertyObservers() {
            ...
            this._properties.position.on('valuechanged', () => this.triggerEvent('propertychange', 'position'));
            this._properties.rotation.on('valuechanged', () => this.triggerEvent('propertychange', 'rotation'));
            this._properties.scale.on('valuechanged', () => this.triggerEvent('propertychange', 'scale'));
            this._properties.origin.on('valuechanged', () => this.triggerEvent('propertychange', 'origin'));
            this._properties.align.on('valuechanged', () => this.triggerEvent('propertychange', 'align'));
            this._properties.mountPoint.on('valuechanged', () => this.triggerEvent('propertychange', 'mountPoint'));
        }
        ...
        _calculateWorldMatrixFromParent() {
            ...
            if ((0, _Utility.isInstanceof)(parent, Transformable))
    ...
    Object.defineProperty(Transformable, Symbol.hasInstance, {
        value: function (obj) {
            if (this !== Transformable) {
                return Object.getPrototypeOf(Transformable)[Symbol.hasInstance].call(this, obj);
            }
...
function isRealNumber(num) {
    if (typeof num != 'number' || Object.is(num, NaN) || Object.is(num, Infinity)) {
        return false;
    }
    return true;
}
