    ...
    var Transformable = function (ParentClass) {
        ...
        Transformable.prototype._setPropertyObservers = function _setPropertyObservers() {
            ...
            this._properties.position.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'position');
            });
            this._properties.rotation.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'rotation');
            });
            this._properties.scale.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'scale');
            });
            this._properties.origin.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'origin');
            });
            this._properties.align.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'align');
            });
            this._properties.mountPoint.on('valuechanged', function () {
                return this$1.triggerEvent('propertychange', 'mountPoint');
            });
        };
