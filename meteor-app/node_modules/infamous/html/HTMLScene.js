...
class HTMLScene extends _Observable2.default.mixin(_DeclarativeBase2.default) {
    static define(name) {
    ...
    initWebGl() {
        ...
        this.mountPromise.then(() => {
            ...
            (0, _WebGLRenderer2.default)().initGl(this);
        });
    }
    //async initWebGl() {
    //// TODO: this needs to be cancelable too, search other codes for
...
(0, _DeclarativeBase.proxyGettersSetters)(_Sizeable2.default, HTMLScene);

exports.default = HTMLScene;
//# sourceMappingURL=HTMLScene.js.map