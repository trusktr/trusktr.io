...
function hijack(original) {
    return function (...args) {
        ...
        if (this instanceof DeclarativeBase) {
            ...
            const observer = (0, _Utility.observeChildren)(root, shadowRootChildAdded.bind(this), shadowRootChildRemoved.bind(this));
            observers.set(root, observer);

            var ref = this;
            var children = ref.children;
            for (let l = children.length, i = 0; i < l; i += 1) {
                if (!(children[i] instanceof DeclarativeBase)) {
                    continue;
                }
...
function initDeclarativeBase() {
     ...
     */
    exports.default = DeclarativeBase = class DeclarativeBase extends (0, _WebComponent2.default)(window.HTMLElement) {
        constructor() {
            super();
            ...
            this._imperativeCounterpartPromise = Promise.resolve().then(() => this._associateImperativeNode());
            this.mountPromise = this._imperativeCounterpartPromise.then(() => this.imperativeCounterpart.mountPromise);
        }
        ...
        _associateImperativeNode(imperativeCounterpart) {
            ...
            // the passed instance.
            if (imperativeCounterpart) {
                this.imperativeCounterpart = imperativeCounterpart;
            }

            // otherwise if called from a MotorHTML class without an argument
            else {
                    this.imperativeCounterpart = this._makeImperativeCounterpart();
                }
        }
        ...
        childConnectedCallback(child) {
            ...
            if (child instanceof _HTMLNode2.default) {
                ...
                if (child.imperativeCounterpart._parent) {
                    return;
                }
        ...
        _handleDistributedChildren(slot) {
            ...
            for (let l = added.length, i = 0; i < l; i += 1) {
                ...
                if (!(addedNode instanceof DeclarativeBase)) {
                    continue;
                }
            ...
            for (let l = removed.length, i = 0; i < l; i += 1) {
                ...
                if (!(removedNode instanceof DeclarativeBase)) {
                    continue;
                }

                removedNode._shadowParent = null;
                this._shadowChildren.delete(removedNode);
                if (!this._shadowChildren.size) {
                    this._shadowChildren = null;
                }
            }
        }
...
function proxyGettersSetters(SourceClass, TargetClass) {
    ...
    // ignored).
    const methodProxyBlacklist = ['constructor', 'parent', 'children', // proxying this one would really break stuff (f.e. React)
...
//# sourceMappingURL=DeclarativeBase.js.map