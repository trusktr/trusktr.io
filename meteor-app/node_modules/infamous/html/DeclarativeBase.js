...
var _WebComponent2 = require('./WebComponent');
    ...
    exports.default = DeclarativeBase = function (_WebComponent) {
        ...
        (0, _createClass3.default)(DeclarativeBase, [{
            ...
            value: function construct() {
                (0, _get3.default)(DeclarativeBase.prototype.__proto__ || (0, _getPrototypeOf2.default)(DeclarativeBase.prototype), 'construct', this).call(this);
            ...
            value: function childConnectedCallback(child) {
                ...
                //) == 'v1'
                    ...
                    if (this instanceof _HTMLNode2.default && !this.isDOMPlane && (!(child instanceof Text) && !(child instanceof Comment) || child instanceof Text && child.textContent.trim().length > 0)) {
            ...
            value: function _createDOMPlane() {
                ...
                var mesh = this._threeDOMPlane = new _three.Mesh(geometry, material);
            ...
            value: function _createDOMPlaneGeometry() {
                return new _three.BoxGeometry(this._calculatedSize.x, this._calculatedSize.y, 1);
            }
            ...
            value: function _handleDistributedChildren(slot) {
                ...
                for (var l = added.length, i = 0; i < l; i += 1) {
                    ...
                    if (!this$1._shadowChildren) {
                        this$1._shadowChildren = [];
                    }
                ...
                for (var l$1 = removed.length, i$1 = 0; i$1 < l$1; i$1 += 1) {
                    ...
                    if (!this$1._shadowChildren.size) {
                        this$1._shadowChildren = null;
                    }
                }
            }
        }, {
            ...
            value: function setAttribute(attr, value) {
                ...
                (0, _get3.default)(DeclarativeBase.prototype.__proto__ || (0, _getPrototypeOf2.default)(DeclarativeBase.prototype), 'setAttribute', this).call(this, attr, value);
            }
        }], [{
            key: 'define',
