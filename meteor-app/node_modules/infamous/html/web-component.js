...
function classExtendsHTMLElement(constructor) {
    ...
    if (constructor === HTMLElement) {
        ...
        return classExtendsHTMLElement(constructor.prototype.__proto__ ? constructor.prototype.__proto__.constructor : null);
    }
}
...
function WebComponentMixin(elementClass) {
    ...
    var WebComponent = function (elementClass) {
        ...
        WebComponent.prototype.connectedCallback = function connectedCallback() {
            if (elementClass.prototype.connectedCallback) {
        ...
        WebComponent.prototype.attachedCallback = function attachedCallback() {
            this.connectedCallback();
        }; // back-compat

        WebComponent.prototype._createStyles = function _createStyles() {
            const rule = _jss2.default.createRule(this.getStyles());
        ...
        WebComponent.prototype.disconnectedCallback = function disconnectedCallback() {
            ...
            if (elementClass.prototype.disconnectedCallback) {
        ...
        //}
        //}
        WebComponent.prototype.detachedCallback = function detachedCallback() {
        ...
        WebComponent.prototype.attributeChangedCallback = function attributeChangedCallback() {
            ...
            if (elementClass.prototype.attributeChangedCallback) {
                elementClass.prototype.attributeChangedCallback.apply(this, args);
            }
