...
var _DeclarativeBase2 = _interopRequireDefault(_DeclarativeBase);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _DeclarativeBase.initDeclarativeBase)();

class HTMLNode extends _DeclarativeBase2.default {
    static define(name) {
    ...
    static get observedAttributes() {
        return ['sizeMode', 'absoluteSize', 'proportionalSize', 'align', 'mountPoint', 'rotation', 'position', 'scale', 'origin', 'skew', 'opacity'].map(a => a.toLowerCase());
    }
...
(0, _DeclarativeBase.proxyGettersSetters)(_Transformable2.default, HTMLNode);
(0, _DeclarativeBase.proxyGettersSetters)(_Sizeable2.default, HTMLNode);
